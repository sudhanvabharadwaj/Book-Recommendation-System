...
class AppConfiguration:
    ...
    def get_model_trainer_config(self) -> ModelTrainerConfig:
        try:
            ...
            response = ModelTrainerConfig(
                transformed_data_dir = transformed_data_file_dir,
    ...
    def get_recommendation_config(self) -> ModelRecommendationConfig:
        try:
            ...
            book_name_serialized_objects = os.path.join(artifacts_dir, dataset_dir, data_validation_config['serialized_objects_dir'], 'book_names.pkl')
            book_pivot_serialized_objects = os.path.join(artifacts_dir, dataset_dir, data_validation_config['serialized_objects_dir'], 'book_pivot.pkl')
            final_rating_serialized_objects = os.path.join(artifacts_dir, dataset_dir, data_validation_config['serialized_objects_dir'], 'final_rating.pkl')
